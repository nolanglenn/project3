    ...
    return (
      ...
      <div className="container valign-wrapper">
        <div className="row">
          ...
          <div className="col s12 center-align">
            <h4 id='subheader'>
              <Link id='dashboardbutton' to='/page2' className='waves-effect waves-light btn-large deep-purple darken-2'>Grab a Job</Link>
              <Link id='dashboardbutton' to='/page1' className='waves-effect waves-light btn-large deep-purple darken-2'>Post a Job</Link>
            </h4>
          </div>
        </div>
      </div>
